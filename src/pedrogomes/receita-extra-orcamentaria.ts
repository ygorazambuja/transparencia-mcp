...
import z from "zod";
import type { ReceitaExtraOrcamentariaSchemaType } from "../../http-schemas/ReceitaExtraOrcamentaria";
import { BASE_URL } from "../shared/constants";

const kat = Katalist();

export const GetReceitaExtraOrcamentariaSearchSchema = z.object({
	diaInicio: z
		.string()
		.describe(
...
export async function receitaExtraOrcamentaria({
	diaInicio,
	mesInicio,
	diaFinal,
	mesFinal,
...
}: z.infer<typeof GetReceitaExtraOrcamentariaSearchSchema>) {
	...
	receitaParams.set("Listagem", "ReceitaExtraOrcamentaria");
	...
	const receita = await kat.get<ReceitaExtraOrcamentariaSchemaType>(
