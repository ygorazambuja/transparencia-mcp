...
import z from "zod";
import type { ReceitaUniaoSchemaType } from "../../http-schemas/ReceitaUniao";
import { BASE_URL } from "../shared/constants";

const kat = Katalist();

export const GetReceitaUniaoSearchSchema = z.object({
	diaInicio: z
		.string()
		.describe(
...
export async function receitaUniao({
	diaInicio,
	mesInicio,
	diaFinal,
	mesFinal,
...
}: z.infer<typeof GetReceitaUniaoSearchSchema>) {
	...
	receitaParams.set("Listagem", "ReceitaUniao");
	...
	const receita = await kat.get<ReceitaUniaoSchemaType>(
